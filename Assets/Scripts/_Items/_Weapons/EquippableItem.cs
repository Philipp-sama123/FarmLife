...
{
    public class EquippableItem : EquipmentItem
    {
        ...
        [Header("Actions")]
        public EquippableItemAction oh_RB_Action; // One Handed Right Bumper Action // ToDo: OH Left Mouse Button (?)
        public EquippableItemAction oh_RT_Action; // One Handed Right Trigger Action // ToDo: OH Right Mouse Button (?)

        public EquippableItemAction oh_LB_Action; // One Handed LEft Bumper Action //
        //  ASH OF WAR
